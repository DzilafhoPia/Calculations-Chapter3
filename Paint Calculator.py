"""Calculate gallons of paint needed to paint the ceiling of a room. Prompt for length and width, and assume that 1
...
width = int(input("What is the width of the room n feet? "))
area = length * width
